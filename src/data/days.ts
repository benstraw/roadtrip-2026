...
export const days: Day[] = [
  ...
  },
  {
    ...
    narrative: [
      'Five in the morning and it was already down. Half an inch on the road, more coming. We decided to go.',
  ...
  },
  {
    ...
    galleryImages: [
      { src: '/images/days/6/placeholder-1.jpg', alt: 'Map book page — Day 6', caption: 'Into Big Bend', wide: true },
      { src: '/images/days/6/placeholder-2.jpg', alt: 'Toes in the Rio Grande', caption: 'First time for both of us' },
      { src: '/images/days/6/placeholder-3.jpg', alt: 'Raymond the bobblehead', caption: 'Raymond. Dashboard mascot. Named on the spot.' },
      { src: '/images/days/6/placeholder-4.jpg', alt: 'Boquillas Canyon', caption: 'The Rio Grande at the bottom. Mexico on the other side.' },
      { src: '/images/days/6/placeholder-5.jpg', alt: 'Three coydogs', caption: 'Coydogs on the road to Boquillas' },
      { src: '/images/days/6/placeholder-6.jpg', alt: 'Chisos Mountains', caption: 'The Chisos Basin — the place we almost stayed' },
    ],
  },
  {
    day: 7,
    ...
    galleryImages: [
      { src: '/images/days/7/placeholder-1.jpg', alt: 'Map book page — Day 7', caption: 'Window Trail and Santa Elena Canyon', wide: true },
      { src: '/images/days/7/placeholder-2.jpg', alt: 'Window Trail pouroff', caption: 'Sky island looking down into the sea of desert' },
      { src: '/images/days/7/placeholder-3.jpg', alt: 'Santa Elena Canyon', caption: 'Santa Elena — 1,500 ft walls, sky a thin strip above' },
      { src: '/images/days/7/placeholder-4.jpg', alt: 'Terry Klein at the Starlight', caption: 'Terry Klein — live music, night three' },
      { src: '/images/days/7/placeholder-5.jpg', alt: 'Terlingua sunset', caption: 'The sunset before the long drive tomorrow' },
    ],
  },
  {
    day: 8,
    ...
    galleryImages: [
      { src: '/images/days/8/placeholder-1.jpg', alt: 'Map book page — Day 8', caption: 'Big Bend to Tucson', wide: true },
      { src: '/images/days/8/placeholder-2.jpg', alt: 'Highway 170', caption: 'The Rio Grande and the Scenic Byway' },
      { src: '/images/days/8/placeholder-3.jpg', alt: 'Marfa TX', caption: 'Marfa — coffee and mail' },
      { src: '/images/days/8/placeholder-4.jpg', alt: 'El Chorro Tucson', caption: 'El Chorro — since 1922' },
    ],
  },
  {
    day: 9,
    ...
    galleryImages: [
      { src: '/images/days/9/placeholder-1.jpg', alt: 'Map book page — Day 9', caption: 'Tucson to California', wide: true },
      { src: '/images/days/9/placeholder-2.jpg', alt: 'California state line', caption: 'California — finally' },
      { src: '/images/days/9/placeholder-3.jpg', alt: 'Santa Monica', caption: 'Locanda Portofino — end of the road dinner' },
      { src: '/images/days/9/placeholder-4.jpg', alt: 'The Pacific', caption: 'A walk from the beach' },
    ],
  },
];
